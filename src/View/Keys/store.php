...
<form action="" method="post">
    <div class="card card-block">
            ...
            <div class="col-sm-10">
                <input type="text" name="type" class="form-control boxed" placeholder=""> </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-2 form-control-label text-xs-right"> État de la clé : </label>
            <div class="col-sm-10">
                <input type="text" name="etat" class="form-control boxed" placeholder=""> </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-2 form-control-label text-xs-right"> Nombre de clé à commander : </label>
            <div class="col-sm-10">
                <input type="text" name="nbCommande" class="form-control boxed" placeholder=""> </div>
        </div>
