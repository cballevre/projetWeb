...
<section class="section">
    <a href="<?php echo WEBROOT; ?>?controller=rooms&action=store" class="btn btn-primary">Ajouter</a>
    <a href="<?php echo WEBROOT; ?>?controller=rooms&action=import" class="btn btn-secondary float-right">Importer</a>
</section>
<section class="section">
    <div class="row">
        <div class="col-md-12">
