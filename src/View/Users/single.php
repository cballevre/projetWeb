...
<section class="mt-4">
    <div class="row">
        <div class="col-3">
            <div class="card">
                <img class="card-img-top" src="http://placekitten.com/g/200/200"
                     alt="Card image cap">
                <div class="card-body">
                    <h5 class="card-title"><?php echo $user->getSurname(
                        ); ?><?php echo $user->getName(); ?></h5>
            ...
            <div class="card text-center">
                ...
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs" id="myTab"
                        role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="borrowKeychain-tab"
                               data-toggle="tab" href="#borrowKeychain"
                               role="tab">Trousseaux empruntés</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="door-tab" data-toggle="tab"
                               href="#door" role="tab" aria-controls="profile"
                               aria-selected="false">Salles accédées</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="key-tab" data-toggle="tab"
                               href="#key" role="tab" aria-controls="profile"
                               aria-selected="false">Clés possédées</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="borrowKeychain"
                         role="tabpanel" aria-labelledby="borrowKeychain-tab">
                        <table class="table table-striped">
                            ...
                            <tbody>
                            <?php foreach(
                                $user->borrowKeychains() as $borrowKeychain
                            ): ?>
                                <tr>
                                    <td>
                                        <a href="<?php echo WEBROOT; ?>?controller=keychains&action=single&id=<?php echo $borrowKeychain->getIdKeychain(
                                        ); ?>">
                                            Trousseau
