...
<head>
    ...
    <!-- FONT
    –––––––––––––––––––––––––––––––––––––––––––––––––– -->
    <link href='https://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,300,800,700,600'
                ...
                <ul class="nav flex-column">
                    ...
                    foreach($menu as $item): ?>
                        <li class="nav-item">
                            ...
                            <?php else: ?>
                                <a class="nav-link" href="<?php echo WEBROOT
                                    . $item['route']; ?>">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 border-bottom">
                <h1 class="h2">
                    <?php if(!is_null($this->back)): ?>
                        <a href="<?php echo WEBROOT . $this->back; ?>"
                           class="pr-3"><i class="fas fa-angle-left"></i></a>
                    <?php endif; ?>
                    ...
                    <div class="btn-group mr-2">
                        <?php if(!is_null($this->button_add)): ?>
                            <button type="button"
                                    ...
                                    id="btn-add" data-action="<?php echo WEBROOT
                                . $this->button_add; ?> ">Ajouter
                            </button>
                        <?php endif; ?>
                        <?php if(!is_null($this->button_import)): ?>
                            <button type="button"
                                    class="btn btn-sm btn-outline-secondary"
                                    data-toggle="modal"
                                    data-target="#modal-import">Importer
                            </button>
                        <?php endif; ?>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form enctype="multipart/form-data"
                      action="<?php echo WEBROOT; ?>?controller=<?php echo $this->name; ?>&action=import"
                      method="post">
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="exampleFormControlFile1">Votre fichier
                                d'import au format csv</label>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form id="modal-form" action="" method="post">
                    <div class="modal-body">
                        <?php Core\Routing\Dispatcher::loadAction(
                            "store", $this
                        ); ?>
                    </div>
                    <div class="modal-footer">
...
<script>
    ...
    $(document).ready(function () {
        $(".btn-modif").click(function () {
            ...
            $.ajax({
                type: 'GET',
                url: "<?php echo WEBROOT ?>?controller=<?php echo $this->getName(
                ) ?>&action=singleToJson&id=" + id,
                dataType: 'json',
                success: function (data) {
                    ...
                    $('#modal-form').attr('action', "<?php echo WEBROOT ?>?controller=<?php echo $this->getName(
                        ) ?>&action=update&id=" + id);
